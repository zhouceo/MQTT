...
char *now_time(void)
{
    ...
    //   printf("%d/%d/%d %d:%d:%d\n", 1900 + myti->tm_year, 1 + myti->tm_mon, myti->tm_mday, myti->tm_hour, myti->tm_min, myti->tm_sec);
    sprintf(time_buff, "%d/%d/%d %d:%d:%d", 1900 + myti->tm_year, 1 + myti->tm_mon, myti->tm_mday, myti->tm_hour, myti->tm_min, myti->tm_sec);
    //    sprintf(time_buff, "%d:%d:%d", myti->tm_hour, myti->tm_min, myti->tm_sec);
    //    sprintf(time_buff, "%02d%3A%02d%3A%02d", myti->tm_hour, myti->tm_min, myti->tm_sec);
    printf("%s\r\n", time_buff);
    return time_buff;
}
