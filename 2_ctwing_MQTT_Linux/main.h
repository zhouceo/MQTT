...
#define CLIENTID "17083223device1"
#define USERNAME "fadsdfa"
#define PASSWORD "ru8B1Lxc4cnVd5hCVNtgKkoqdaLIjAfR9eSOjEzrV1s"
// 数据上报
#define DATA_REPORT "send_data"       // 业务数据上报{"temperature":25,"hydraulic_value":5}
#define SIGNAL_REPORT "signal_report" // 信号数据上报
// 事件上报
#define BATTERY_VOLTAGE_LOW_ALARM "battery_voltage_low_alarm" // 电池低电压告警
#define ERROR_CODE_REPORT "error_code_report"                 // 故障上报
// 指令下发
#define VALVE_ONOFF_CMD "valve_onoff_cmd"         // 阀门开关控制
#define VALVE_ONOFF_RESP "valve_onoff_resp"       // 阀门开关控制
#define SET_CONFIG_CMD "set_config_cmd"           // 配置下发
#define SET_CONFIG_CMD_RESP "set_config_cmd_resp" // 配置下发响应
